...
def home():
    ...
    for i in range(len(questions)):
        ...
        # st.caption("<p align='right'>Default answer generated by ChatGPT<br/>OpenAI (2023) https://chat.openai.com</p>", unsafe_allow_html = True)
        currentGraphConfig = {
            'graphColor': color,
        ...
        st.caption("Default answer generated by ChatGPT")
        generate = st.selectbox(
            'OpenAI (2023) https://chat.openai.com',
            ['Bar Graph','Javascipt Object Notation (JSON)'],
            key = f'select{i}'
        )
